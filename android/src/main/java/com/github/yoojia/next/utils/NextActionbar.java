...
public class NextActionbar {
    ...
    public void setLeftImageButton(int resId, View.OnClickListener listener) {
    ...
    public void setLeftTextButton(int resId, View.OnClickListener listener) {
    ...
    public void setRightImageButton(int resId, View.OnClickListener listener) {
    ...
    public void setRightTextButton(int resId, View.OnClickListener listener) {
