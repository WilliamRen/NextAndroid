...
import com.github.yoojia.next.lang.Splitter;
...
public class MapAccessor {
    ...
    private MapAccessor(Map<String, Object> source) {
        this.mSource = source;
    ...
    public Object get(String keyChain, Object defValue){
        ...
        final Iterable<String> keys = Splitter.on('.').split(keyChain);
        final List<String> _keyChain = new ArrayList<>();
        for (Iterator<String> iterator = keys.iterator(); iterator.hasNext();) {
            _keyChain.add(iterator.next());
        }
    ...
    public static MapAccessor use(Map<String, Object> source){
